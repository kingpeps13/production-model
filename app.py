...
def calculate(data, Q, N, correction_choice):
    ...
    for j in range(m):
        current_time = naryad_ready[j]   # наряд ждёт завершения предыдущей операции
    ...
    return {
        ...
        'shift_start': shift_start,        # ← обязательно для Gantt
